...
const F = "'DM Sans',system-ui,-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif";
...
<table border="0" cellpadding="0" cellspacing="0" width="640" class="wrap"
            ...
            <table border="0" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <td style="vertical-align:middle;line-height:1;">
                  ...
                  <div style="font-size:15px;font-weight:800;color:#b8960c;font-family:${F};letter-spacing:0.02em;line-height:1.15;white-space:nowrap;">WHOLESALE</div>
                </td>
              </tr>
            </table>
          </td>
  ...
  <tr>
    <td style="padding:20px 28px 0;">
      <!-- Hero card with soft warm surface bg -->
      <table border="0" cellpadding="0" cellspacing="0" width="100%"
        style="background-color:#fafaf7;border:1px solid #e8e4dd;border-radius:14px;border-collapse:separate;overflow:hidden;">
        <tr>
          <!-- Left: Amount info -->
      ...
      <table border="0" cellpadding="0" cellspacing="0" width="100%"
        ...
        <tr>
          ...
          <td class="meta-col" width="34%" style="padding:18px 20px;vertical-align:top;text-align:left;">
            ...
            <div style="font-size:12px;color:#b8960c;font-family:${F};">${customerEmail}</div>
          </td>
          <!-- Col 2: Issued -->
  ...
  <tr>
    <td style="padding:22px 28px 8px;">
      <div style="font-size:11px;font-weight:700;color:#b8960c;text-transform:uppercase;letter-spacing:0.09em;font-family:${F};">Order Summary</div>
    </td>
  </tr>
          ...
          <td colspan="4" style="padding:14px 20px 18px;">
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
              <tr>
                ...
                <td style="text-align:right;font-size:17px;font-weight:800;color:#b8960c;font-family:${F};letter-spacing:-0.02em;width:110px;">${fmt(total)}</td>
              </tr>
            </table>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td class="btn-col" width="50%" style="padding-right:10px;vertical-align:middle;">
            <table border="0" cellpadding="0" cellspacing="0" width="100%" class="btn-table">
              <tr>
                <td align="center" style="background-color:#b8960c;border-radius:10px;">
          ...
          <td class="btn-col" width="50%" style="padding-left:10px;vertical-align:middle;">
            <table border="0" cellpadding="0" cellspacing="0" width="100%" class="btn-table">
              <tr>
                <td align="center" style="background-color:#ffffff;border:1.5px solid #b8960c;border-radius:10px;">
                  <a href="${pdfUrl}" target="_blank"
                    style="display:block;padding:14px 20px;font-size:14px;font-weight:600;color:#b8960c;text-decoration:none;text-align:center;font-family:${F};border-radius:10px;">
                    &#8675; Download PDF
                  </a>
                </td>
              </tr>
  ...
  <tr>
    <td style="padding:0 28px 28px;" class="help-card-container">
      <table border="0" cellpadding="0" cellspacing="0" width="100%"
        style="background-color:#fafaf7;border:1px solid #e8e4dd;border-radius:12px;border-collapse:separate;">
        <tr>
  ...
  <tr>
    <td style="padding:20px 28px 28px;border-top:1px solid #F1F5F9;text-align:center;">
      ...
      <div style="font-size:12px;color:#64748B;font-family:${F};margin-bottom:14px;">
        Labuan FT, Malaysia &nbsp;&bull;&nbsp; <a href="mailto:support@goldenisle.com" style="color:#b8960c;text-decoration:none;font-weight:500;">Contact Us</a>
      </div>
