...
const StepBadge = ({ number, active, done }: { number: string; active: boolean; done: boolean }) => (
  <div style={{
    ...
    background: "#1a1a0e", // Always black as requested
    color: "#ffffff",        // Always white as requested
    transition: "all 0.3s ease",
    flexShrink: 0,
    opacity: (active || done) ? 1 : 0.3, // Distinction by opacity instead of color
  }}>
...
const css = `
  ...
  :root {
    ...
    --muted: #9a9a8a;
    --success: #1a1a0e; /* Changed from green to monochrome placeholder if needed */
    --radius-sm: 10px;
    --radius-md: 14px;
    --radius-lg: 20px;
  }
