...
import { Menu, X, LayoutDashboard, Package, ShoppingBag, Settings, ExternalLink, TrendingUp, LogOut, Sun, Moon, Megaphone, CreditCard, ShieldCheck, Inbox, Bell, Banknote, FileText, RefreshCw, Share2 } from "lucide-react";
        ...
        <>
            ...
            <aside className={`fixed top-0 left-0 h-screen w-64 bg-slate-900 text-white flex flex-col z-[60] transition-transform duration-300 md:translate-x-0 ${sidebarOpen ? "translate-x-0" : "-translate-x-full"}`}>
                ...
                <nav className="flex-1 px-3 py-4 space-y-0.5 overflow-y-auto">
                    ...
                    {navItem("/admin/invoices", "Invoices", FileText)}
                    ...
                    {navItem("/admin/meta-catalog", "Meta Catalog", Share2)}
                </nav>
