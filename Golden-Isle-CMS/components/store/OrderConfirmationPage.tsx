                                        ...
                                        {waLink && (
                                            <div className="p-5 bg-white rounded-2xl border border-slate-200/80 flex justify-between items-center shadow-sm">
                                                ...
                                                <a
                                                    ...
                                                    className="py-2 px-4 bg-[#008069] hover:bg-[#006653] text-white rounded-lg text-xs font-bold transition text-center flex items-center gap-1.5"
                                                >
...
const WhatsappIcon = ({ className = "", color = "#008069" }: { className?: string; color?: string }) => (
    <svg viewBox="0 0 2500 2500" fill="none" className={`shrink-0 ${className}`}>
        {/* Outer speech bubble */}
        <path 
            fill={color} 
